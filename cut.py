...
def main():
    ...
    if len(sys.argv) == 1:
        ...
        if f not in ['cut', 'cut_memo', 'cut_it']:
            ...
            fun = globals()[f]
            print(
                f'Executando {f} para uma instância aleatória de tamanho n = {n}')
            s = time.time()
            fun(n, gen(n))
        ...
        print('Modo de uso:')
        print(
            f'python3 {sys.argv[0]} [cut|cut_meno|cut_it n], onde o primeiro argumento é a função e n é o tamanho do problema')
